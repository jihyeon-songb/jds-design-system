...
describe("Tabs", () => {
  ...
  it("renders linked native tab semantics and forwards refs", () => {
    ...
    expect(rootRef.current).toHaveClass("jdsb-tabs", "custom-tabs")
    ...
    expect(listRef.current).toHaveClass("jdsb-tabs-list", "custom-list")
    expect(triggerRef.current).toHaveAttribute("type", "button")
    expect(triggerRef.current).toHaveClass("jdsb-tabs-trigger", "custom-trigger")
    expect(tab).toHaveAttribute("aria-selected", "true")
    expect(tab).toHaveAttribute("aria-controls", panel.id)
    expect(panel).toHaveAttribute("aria-labelledby", tab.id)
    expect(contentRef.current).toHaveClass("jdsb-tabs-content", "custom-content")
